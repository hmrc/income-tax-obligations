...
package uk.gov.hmrc.incometaxobligations.helpers

import uk.gov.hmrc.incometaxobligations.helpers.servicemocks.AuthStub
...
trait ComponentSpecBase extends TestSuite with CustomMatchers
  ...
  object Obligations {
    ...
    def getFulfilledObligations(nino: String, from: String, to: String): WSResponse = get(s"/$nino/fulfilled-obligations/from/$from/to/$to")
